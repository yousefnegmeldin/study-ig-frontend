...
const Waitlist = () => {
  return (
    ...
    //   </div>
    // </main>
    <main className=" h-screen w-screen bg-white bg-grid-black/[0.2] relative flex items-center justify-center gap-10">
      ...
      <div className="h-1/2 p-8 shadow-2xl bg-white bg-opacity-40 rounded-lg backdrop-blur-lg border border-white">
        <h1 className="text-7xl font-bold text-brand">Study IG</h1>
        <Image alt="logo" src={Book} width={300} />
      </div>

      <div className="h-1/2 flex flex-col gap-4 w-1/5 justify-center items-center p-8 shadow-2xl bg-white bg-opacity-40 rounded-lg backdrop-blur-lg border border-white">
